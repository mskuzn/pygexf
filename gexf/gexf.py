...
class Gexf:
    ...
    def write(self, file, print_stat=True):
        ...
        buf = etree.tostring(self.getXML(), pretty_print=True, encoding='utf-8', xml_declaration=True)
        if type(buf) == bytes:
...
class Graph:
    ...
    def addNode(self, id, label, start="", end="", startopen=False, endopen=False, pid="", r="", g="", b="",x="",y="", spells=[]):
        self._nodes[str(id)] = Node(self, id, label, start, end, pid, r, g, b, x,y, spells, startopen, endopen)
...
class Node:
    ...
    def __init__(self, graph, id, label, start="", end="", pid="", r="", g="", b="",x="",y="", spells=[], startopen=False, endopen=False):
        self.id = id
        self.label = label
        self.start = start
    ...
    def getXML(self):
        ...
        try:
            ...
            if not self.r == "" and not self.g == "" and not self.b == "":
                ...
                colorXML = etree.SubElement(nodeXML, "color")
            ...
            if not self.x == "" and not self.y == "":
                ...
                positionXML = etree.SubElement(nodeXML, "position")
    ...
    def importXML(nodes_xml, graph_obj):
        ...
        for child in nodes_xml:
            ...
            if tag == "node":
                ...
                node_obj = graph_obj.addNode(id=id, label=label, start=start, end=end, startopen=startopen, endopen=endopen, pid=pid, r=r, g=g, b=b,x=x,y=y, spells=spells)
